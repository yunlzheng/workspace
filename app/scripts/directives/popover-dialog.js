...
angular.module('tower.directives.tooltip', ['ngAnimate', 'mgcrea.ngStrap.helpers.dimensions'])
  ...
  .provider('$tooltip', function() {
    ...
    var defaults = this.defaults = {
      ...
      container: false,
      placement: 'top',
      template: 'partials/tooltip.html',
...
angular.module('tower.directives.popover', ['tower.directives.tooltip'])
  ...
  .provider('$popover', function() {
    ...
    var defaults = this.defaults = {
      animation: 'am-fade',
      placement: 'right',
      template: 'partials/popover.html',
      contentTemplate: false,
      trigger: 'click',
      keyboard: true,
      html: false,
